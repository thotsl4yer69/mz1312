...
const evidence = [
  ...
  {
    project: 'MURMUR',
    maturity: 'ACTIVE HARDWARE R&D',
    evidence: 'Wearable architecture · embedded electronics · sensing · optical/haptic interfaces · power/interlock design',
    presentation: 'Engineering case study with validated-vs-planned boundaries',
    tone: 'text-violet-200',
    statusUrl: './work/murmur/',
  },
  {
    project: 'DRIFTER',
  ...
  },
  {
    ...
    maturity: 'RELEASE-READY PROTOTYPE',
    evidence: 'Phaser 3 · TypeScript simulation · Three.js story cuts · PWA packaging · Playwright E2E + asset/build gates',
    presentation: 'Playable engineering case study',
    tone: 'text-orange-200',
    statusUrl: './work/thegame/',
  },
  {
    project: 'AKARI',
    maturity: 'APPLICATION PROTOTYPE',
